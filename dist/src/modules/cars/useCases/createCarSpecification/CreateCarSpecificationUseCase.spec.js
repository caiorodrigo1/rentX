...
const CreateCarSpecificationsUseCase_1 = require("./CreateCarSpecificationsUseCase");
...
describe("Create Car Specification", () => {
    beforeEach(() => {
        ...
        specificationsRepositoryInMemory = new SpecificationsRepositoryInMemory_1.SpecificationRepositoryInMemory();
        createCarSpecificationUseCase = new CreateCarSpecificationsUseCase_1.CreateCarSpecificationUseCase(carsRepositoryInMemory, specificationsRepositoryInMemory);
    });

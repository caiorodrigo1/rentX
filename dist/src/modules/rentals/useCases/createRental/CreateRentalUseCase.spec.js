...
const RentalRepositoryInMemory_1 = require("../../repositories/in-memory/RentalRepositoryInMemory");
...
describe("Create Rental", () => {
    ...
    beforeEach(() => {
        rentalsRepositoryInMemory = new RentalRepositoryInMemory_1.RentalsRepositoryInMemory();

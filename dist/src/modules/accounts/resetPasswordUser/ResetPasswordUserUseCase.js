...
let ResetPasswordUserUserCase = class ResetPasswordUserUserCase {
    ...
    execute({ token, password }) {
        return __awaiter(this, void 0, void 0, function* () {
            const userToken = yield this.usersTokensRepository.findByRefreshToken(token);
            if (!userToken) {
...
ResetPasswordUserUserCase = __decorate([
